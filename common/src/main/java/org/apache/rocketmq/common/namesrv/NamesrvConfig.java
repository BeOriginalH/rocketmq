...
public class NamesrvConfig{
    ...
    /**
     * rocketmq主目录，可以通过-Drocketmq.home.dir指定，也可以通过环境变量ROCKETMQ_HOME指定
     */
    private String rocketmqHome = System
        .getProperty(MixAll.ROCKETMQ_HOME_PROPERTY, System.getenv(MixAll.ROCKETMQ_HOME_ENV));

    /**
     * namesrv存储kv配置属性的持久化路径${user.home}/namesrv/KvConfig.json
     */
    private String kvConfigPath =
        System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "kvConfig.json";

    /**
     * namesrv默认配置文件路径 ${user.home}/namesrv/namesrv.propertires
     */
