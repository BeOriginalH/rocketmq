...
public class MessageStoreConfig{
    ...
    /**
     * commitlog文件的默认大小，默认1G
     */
    private int mappedFileSizeCommitLog = 1024 * 1024 * 1024;

    /**
     * 单个ConsumeQueue的大小。默认是30W个条目，每个条目20字节，总共600w字节
     */
    private int mappedFileSizeConsumeQueue = 300000 * ConsumeQueue.CQ_STORE_UNIT_SIZE;

    /**
     * 是否启用ConsumeQueue的扩展属性
     */
    private boolean enableConsumeQueueExt = false;

    /**
     * ConsumeQueueExt 扩展文件的大小，默认48K
     */
    private int mappedFileSizeConsumeQueueExt = 48 * 1024 * 1024;

    /**
     * ConsumeQueue扩展属性过滤bitMap的大小
     */
     ...
     */
    /**
     * 消息存储到commitlog文件时获取到的锁类型，true为ReentrantLock,false为自旋锁
     */
    private boolean useReentrantLockWhenPutMessage = false;

    /**
     * FlushIntervalCommitlog的时间等待类型，true使用sleep，false使用await方式
     */
    @ImportantField
    ...
    /**
     * commitlog一次刷盘至少需要脏页数量
     */
    private int flushCommitLogLeastPages = 4;

    /**
     * commitlog一次提交至少需要脏页数量
     */
